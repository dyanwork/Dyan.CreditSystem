...
export class SideBarNavComponent extends AppComponentBase {
    ...
    menuItems: MenuItem[] = [
        new MenuItem(this.l("负债查询"), "", "home", "/app/home"),
        new MenuItem(this.l("进件管理"), "", "home", "/app/home"),
        new MenuItem(this.l("下单管理"), "", "home", "/app/home"),
        new MenuItem(this.l("子账号管理"), "", "home", "/app/home"),
        new MenuItem(this.l("充值中心"), "", "home", "/app/home"),
        new MenuItem(this.l("系统设置"), "", "home", "/app/home"),
